...
class TestOrchestrator(unittest.TestCase):
    ...
    def test_get_git_auth_header(self):
        ...
        expected_token_b64 = base64.b64encode(b"x-access-token:fake_token").decode("utf-8")
        self.assertEqual(header, f"http.extraheader=AUTHORIZATION: Basic {expected_token_b64}")

    def test_enforce_https_url(self):
        """Verify that SSH git repository URLs are correctly converted to HTTPS."""
        test_cases = [
            ("git@github.com:my-org/my-repo.git", "https://github.com/my-org/my-repo.git"),
            ("ssh://git@github.com/my-org/my-repo.git", "https://github.com/my-org/my-repo.git"),
    ...
    def test_sanitize_git_url(self):
        ...
        test_cases = [
            ("https://github.com/my-org/my-repo.git", "https://github.com/my-org/my-repo.git"),
            ("https://x-access-token:token123@github.com/my-org/my-repo.git", "https://github.com/my-org/my-repo.git"),
            ("http://user:pass@github.corp.com:8443/org/repo?branch=main#readme", "http://github.corp.com:8443/org/repo"),
    ...
    def test_parse_repo_owner_and_name(self):
        ...
        test_cases = [
            ...
            ("https://x-access-token:tok@github.com/my-org/my-repo", ("my-org", "my-repo")),
